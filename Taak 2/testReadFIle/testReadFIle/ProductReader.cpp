...
ProductReader::ProductReader(const std::string& filename) : filename(filename) {}

void ProductReader::loadProductsIntoTrie(Trie& trie) {
    // Open the CSV file
    ifstream inputFile("../testcsv.csv");
    ...
    while (getline(inputFile, line)) {
        ...
        // todo push to products
        cout << " ASIN: " << product.asin << ", Title: " << product.title << ", Price: " << product.price << endl;
    }
...
// Function to remove double quotes from the string
